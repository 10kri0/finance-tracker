...
🛠️  Built with   : Django (Backend) + React / Vite (Frontend)
...
✨ Key Capabilities:
  ...
  - 🛡️ Mandatory balance categories: Bank Savings & Cash Spending.
...
================================================================================
  ...
  6.7 ⚙️ SET EXPENSE BUDGETS PAGE (/budgets)
  -----------------------------------------------
...
================================================================================
  ...
  🛠️ PREREQUISITES: Python 3.10+, Node.js 18+, npm 9+
...
================================================================================
  ...
  ❌ "no such column: tracker_expense.payment_method"
    -> Run: python manage.py makemigrations tracker && python manage.py migrate 🛠️
